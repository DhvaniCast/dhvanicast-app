...
class ChildSafetyScreen extends StatelessWidget {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () => launchUrl(
                          Uri.parse('mailto:csae@dcaudiorooms.com'),
                        ),
                        child: Text(
                          'csae@dcaudiorooms.com',
                          style: TextStyle(
                            color: Theme.of(context).colorScheme.primary,
                  ...
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () => launchUrl(
                          Uri.parse('mailto:Support@dcaudiorooms.com'),
                        ),
                        child: Text(
  ...
  static List<Widget> _policySections(BuildContext context) {
    ...
    return [
      ...
      const SizedBox(height: 8),
      Text(
        'Any CSAE-related content or behavior is treated as a serious criminal matter and handled with the highest priority.',
        style: body,
      ),
      const SizedBox(height: 24),
      ...
      const SizedBox(height: 8),
      Text(
        'There are no exceptions, including fictional, artistic, or "joke" content.',
        style: red,
      ),
      const SizedBox(height: 24),
      ...
      _bulletedList([
        ...
        'Submitting a report via email to csae@dcaudiorooms.com',
      ], indent: 12),
      const SizedBox(height: 4),
      ...
      const SizedBox(height: 4),
      Text('Where applicable, DC Audio Rooms cooperates with:', style: body),
      _bulletedList([
        'Government agencies',
        'Platform partners',
        'Regulatory bodies',
      ...
      Container(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 8),
            GestureDetector(
              onTap: () => launchUrl(Uri.parse('mailto:csae@dcaudiorooms.com')),
              child: Text(
                'csae@dcaudiorooms.com',
                style: TextStyle(
                  color: Theme.of(context).colorScheme.primary,
